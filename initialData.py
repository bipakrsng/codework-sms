...
with app.app_context():
    ...
    datastore.find_or_create_role(name='parent',description="User is a parent with limited access")
    ...
    if not datastore.find_user(email="parent@gmail.com"):
        datastore.create_user(email="parent@gmail.com",username="parent", password=generate_password_hash("parent123"),roles=["parent"])
    db.session.commit()
